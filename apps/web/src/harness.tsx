...
const clocks: Clock[] = withClocks
  ? [
      ...
      },
      {
        ...
        Segments: 4,
        SuccessMarks: 2,
        Goal: 'The city guard learns the Heroes broke curfew and starts actively hunting them.',
        SkillTags: ['City Guard', 'Informants'],
        Developments: [
          { Id: 'dev-harness-1', Text: 'A guard patrol recognizes a Hero on sight.', Triggered: true },
          { Id: 'dev-harness-2', Text: 'A bounty is posted.', Triggered: false },
        ],
      ...
      },
      {
        Id: 'clk-harness-3',
        CampaignId: campaign.Id,
        Title: 'Forge the Ward-Blade',
        Kind: 'Project',
        Segments: 6,
        SuccessMarks: 1,
        Goal: 'A blade that cuts through the Fair Folk Glamour.',
        SkillTags: [],
        Developments: [],
        PromotedToBoard: false,
        Status: 'Open',
...
const chargenBootstrap: CampaignBootstrap = {
  ...
  users,
  characters: [],
  party: { Id: 'pt-chargen', CampaignId: 'cm-3', Rapport: 0, Misfortune: 1, RapportImprovementsTaken: [], History: [], PartyLevel: 0, Motif: '', Quest: '', SkillTags: [], WeaknessTags: [], MotifId: null, FlawTags: [], UsedTags: [], QuestKind: null, ActBreaks: 0, Forsakes: 0, Path: '', Goal: '', CampAssets: [], UpdatedAt: new Date().toISOString(), UpdatedBy: null },
  bonds: [],
  invites: [],
  mySheet: null,
  peekSheets: {},
