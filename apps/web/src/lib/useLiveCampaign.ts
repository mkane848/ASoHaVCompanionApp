 ...
 *  queries when Party, a Bond, a sheet, a Combat Encounter, a Clock, or the content library
 *  changes elsewhere.
 *
 *  No access-control logic lives here: `party`/`bonds`/`character_sheets`/`combat_encounters`/
 *  `clocks` all have RLS SELECT policies (supabase/migrations/0001-0006, 0010-0011), and Realtime
