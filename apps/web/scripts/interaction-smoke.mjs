...
const STATES = [
  ...
  { name: 'modal: Take Strain', route: 'route=/c/cm-1/sheet&as=ryan',
    open: (p) => byName(p, 'Take Strain…').click(), scope: DIALOG, close: (p) => p.keyboard.press('Escape') },
  { name: 'modal: Recuperate', route: 'route=/c/cm-1/sheet&as=ryan',
    open: (p) => byName(p, 'Recuperate…').click(), scope: DIALOG, close: (p) => p.keyboard.press('Escape') },
  ...
  { name: 'modal: Set Out', route: 'route=/c/cm-1/sheet&as=ryan',
    open: (p) => byName(p, 'Set Out').click(), scope: DIALOG, close: (p) => p.keyboard.press('Escape') },
