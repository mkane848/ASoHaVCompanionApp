...
| **No Bond row is ever created** outside the seed | `insertBond` (`repo.ts`) is called only by `seed.ts` | Slice 5 (5A) ✅ `0.61.0` |
...
#### Slice 5 — Connections and Bond · reset · ✅ built, `0.61.0`
